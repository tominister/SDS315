...
marketTibble <- tibble()
marketTibble <- rbind(marketTibble,tibble(Symbol="AAPLModel", Intercept=coef(AAPLModel)[1], Slope=coef(AAPLModel)[2], Rsquared=cor(market$SPY,market$AAPL)))
marketTibble <- rbind(marketTibble,tibble(Symbol="GOOGModel", Intercept=coef(GOOGModel)[1], Slope=coef(GOOGModel)[2], Rsquared=cor(market$SPY,market$GOOG)))
marketTibble <- rbind(marketTibble,tibble(Symbol="MRKModel", Intercept=coef(MRKModel)[1], Slope=coef(MRKModel)[2], Rsquared=cor(market$SPY,market$MRK)))
marketTibble <- rbind(marketTibble,tibble(Symbol="JNJModel", Intercept=coef(JNJModel)[1], Slope=coef(JNJModel)[2], Rsquared=cor(market$SPY,market$JNJ)))
marketTibble <- rbind(marketTibble,tibble(Symbol="WMTModel", Intercept=coef(WMTModel)[1], Slope=coef(WMTModel)[2], Rsquared=cor(market$SPY,market$WMT)))
marketTibble <- rbind(marketTibble,tibble(Symbol="TGTModel", Intercept=coef(TGTModel)[1], Slope=coef(TGTModel)[2], Rsquared=cor(market$SPY,market$TGT)))
marketTibble
```
